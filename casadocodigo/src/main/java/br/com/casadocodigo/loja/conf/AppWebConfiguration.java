...
public class AppWebConfiguration {
	...
	*/
	...
	/*
	 * Interceptors funcionam como filtros, só que dentro do framework. No nosso caso, para o idioma, o
	 * LocaleChanceInterceptor verifica se foi usado o parâmetro locale na requisição e, em caso positivo,
	 * ele efetua a troca do idioma.
	 */
	...
	/*
	 * Retorna uma implementação da interface LocaleResolver. Nesse caso, guardamos o idioma preferido em 
	 * um cookie. Poderiamos utilizar SessionLocaleResolver, para armazenar na sessão do usuário. Além
	 * disso, precisamos ensinar ao Spring que ele deve trocar o valor do idioma em função do parâmetro
	 * passado.
	 */
	@Bean
